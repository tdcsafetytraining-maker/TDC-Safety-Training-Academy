...
export const courseCatalog: CourseCatalogItem[] = [
  ...
  { id: 'HSK-010', standard: '29 CFR 1926.25', shortLabel: 'HOUSEKEEPING / FOD', titles: { en: 'Housekeeping & FOD Prevention', ar: 'النظافة ومنع الأجسام الغريبة', ur: 'ہاؤس کیپنگ اور FOD کی روک تھام', hi: 'हाउसकीपिंग और FOD रोकथाम' }, references: '29 CFR 1926.25', contentReady: true },

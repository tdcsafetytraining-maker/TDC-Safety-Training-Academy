...
export const courseCatalog: CourseCatalogItem[] = [
  ...
  { id: 'SCA-003', standard: '29 CFR 1926 Subpart L', shortLabel: 'SCAFFOLDING', titles: { en: 'Scaffolding Safety', ar: 'سلامة السقالات', ur: 'اسکیفولڈنگ سیفٹی', hi: 'मचान सुरक्षा' }, references: '29 CFR 1926.450–1926.454', contentReady: false },

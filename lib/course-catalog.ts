...
export const courseCatalog: CourseCatalogItem[] = [
  ...
  { id: 'FOP-004', standard: '29 CFR 1926.501(c), 1926.502(j)', shortLabel: 'FALLING OBJECTS', titles: { en: 'Falling-Object Prevention', ar: 'منع سقوط الأجسام', ur: 'گرتی اشیاء کی روک تھام', hi: 'गिरती वस्तुओं की रोकथाम' }, references: '29 CFR 1926.100; 1926.501(c); 1926.502(i)–(j); 1926.451(h); 1926.1425', contentReady: true },
  { id: 'HEM-005', standard: '29 CFR 1926.602', shortLabel: 'HEAVY EQUIPMENT', titles: { en: 'Heavy Equipment & Mobile Plant', ar: 'المعدات الثقيلة والآليات المتحركة', ur: 'بھاری مشینری اور موبائل پلانٹ', hi: 'भारी उपकरण और मोबाइल प्लांट' }, references: '29 CFR 1926.20; 1926.200–.201; 1926.600–.602; 1910.178(l)', contentReady: true },
  { id: 'MMI-006', standard: '29 CFR 1926.600–.602', shortLabel: 'MAN–MACHINE', titles: { en: 'Man–Machine Interaction & Struck-By Hazards', ar: 'تفاعل الإنسان والآلة ومخاطر الاصطدام', ur: 'انسان–مشین تعامل اور ٹکر کے خطرات', hi: 'मानव–मशीन संपर्क और टकराने के खतरे' }, references: '29 CFR 1926.600–1926.602; 1926.200–1926.203', contentReady: true },
  { id: 'RIG-007', standard: '29 CFR 1926.251', shortLabel: 'LIFTING & RIGGING', titles: { en: 'Lifting & Rigging', ar: 'الرفع وتجهيز الأحمال', ur: 'لفٹنگ اور رِگنگ', hi: 'लिफ्टिंग और रिगिंग' }, references: '29 CFR 1926.251', contentReady: true },
  { id: 'SIG-008', standard: '29 CFR 1926.1428', shortLabel: 'SIGNAL PERSON', titles: { en: 'Crane Signal Person & Flagman', ar: 'مسؤول إشارات الرافعة والموجّه', ur: 'کرین سگنل پرسن اور فلیگ مین', hi: 'क्रेन सिग्नल पर्सन और फ्लैगमैन' }, references: '29 CFR 1926.1428; 1926.1416; 1926.201', contentReady: true },
  { id: 'FIR-009', standard: '29 CFR 1926.352', shortLabel: 'FIRE WATCH', titles: { en: 'Fire Prevention & Fire Watch', ar: 'الوقاية من الحريق ومراقب الحريق', ur: 'آگ سے بچاؤ اور فائر واچ', hi: 'अग्नि रोकथाम और फायर वॉच' }, references: '29 CFR 1926.150–1926.152; 1926.352; 1910.252(a)(2)(iii)(B)', contentReady: true },
  { id: 'HSK-010', standard: '29 CFR 1926.25; 1926.252', shortLabel: 'HOUSEKEEPING / FOREIGN OBJECT DEBRIS', titles: { en: 'Housekeeping & Foreign Object Debris (FOD) Prevention', ar: 'النظافة ومنع حطام الأجسام الغريبة (FOD)', ur: 'ہاؤس کیپنگ اور Foreign Object Debris (FOD) کی روک تھام', hi: 'हाउसकीपिंग और Foreign Object Debris (FOD) रोकथाम' }, references: '29 CFR 1926.25; 1926.252', contentReady: true },
  { id: 'EXC-011', standard: '29 CFR 1926 Subpart P', shortLabel: 'EXCAVATIONS', titles: { en: 'Excavation & Trenching', ar: 'الحفريات والخنادق', ur: 'کھدائی اور خندقیں', hi: 'खुदाई और खाइयाँ' }, references: '29 CFR 1926.650–1926.652', contentReady: true },
  { id: 'ELC-012', standard: '29 CFR 1926 Subpart K', shortLabel: 'ELECTRICAL', titles: { en: 'Electrical Safety', ar: 'السلامة الكهربائية', ur: 'برقی حفاظت', hi: 'विद्युत सुरक्षा' }, references: '29 CFR 1926.400–1926.449', contentReady: true },
  { id: 'LOTO-013', standard: '29 CFR 1926.417', shortLabel: 'LOCKOUT / TAGOUT', titles: { en: 'Lockout/Tagout for Construction', ar: 'القفل ووضع البطاقات في الإنشاءات', ur: 'تعمیرات کے لیے لاک آؤٹ/ٹیگ آؤٹ', hi: 'निर्माण के लिए लॉकआउट/टैगआउट' }, references: '29 CFR 1926.417; applicable 29 CFR 1910.147', contentReady: true },
  { id: 'PPE-014', standard: '29 CFR 1926 Subpart E', shortLabel: 'PPE', titles: { en: 'Personal Protective Equipment', ar: 'معدات الوقاية الشخصية', ur: 'ذاتی حفاظتی سامان', hi: 'व्यक्तिगत सुरक्षा उपकरण' }, references: '29 CFR 1926.95–1926.107', contentReady: true },
  { id: 'HPT-015', standard: '29 CFR 1926 Subpart I', shortLabel: 'TOOLS', titles: { en: 'Hand & Power Tool Safety', ar: 'سلامة الأدوات اليدوية والكهربائية', ur: 'ہینڈ اور پاور ٹول سیفٹی', hi: 'हाथ और पावर टूल सुरक्षा' }, references: '29 CFR 1926.300–1926.307', contentReady: true },
  { id: 'HAZ-016', standard: '29 CFR 1926.59', shortLabel: 'HAZCOM', titles: { en: 'Hazard Communication', ar: 'التواصل بشأن المخاطر', ur: 'خطرات سے متعلق مواصلات', hi: 'खतरा संचार' }, references: '29 CFR 1926.59; 29 CFR 1910.1200', contentReady: true },
  { id: 'EMR-017', standard: '29 CFR 1926.35', shortLabel: 'EMERGENCY', titles: { en: 'Emergency Response', ar: 'الاستجابة للطوارئ', ur: 'ہنگامی ردِعمل', hi: 'आपातकालीन प्रतिक्रिया' }, references: '29 CFR 1926.35; 1926.50; 1926.150', contentReady: true },
  { id: 'STM-018', standard: '29 CFR 1926.250', shortLabel: 'MATERIAL STORAGE', titles: { en: 'Safe Material Storage', ar: 'التخزين الآمن للمواد', ur: 'مواد کا محفوظ ذخیرہ', hi: 'सुरक्षित सामग्री भंडारण' }, references: '29 CFR 1926.250; 1926.350', contentReady: true },
  { id: 'PTW-019', standard: 'TDC PTW + applicable OSHA rules', shortLabel: 'PERMIT TO WORK', titles: { en: 'Permit to Work', ar: 'تصريح العمل', ur: 'پرمٹ ٹو ورک', hi: 'कार्य परमिट' }, references: '29 CFR 1926.20; applicable task standards; TDC PTW program', contentReady: true },
  { id: 'BAR-020', standard: '29 CFR 1926 Subpart G', shortLabel: 'BARRIERS & SIGNS', titles: { en: 'Barriers, Signs & Barricades', ar: 'الحواجز والعلامات', ur: 'رکاوٹیں اور نشانیاں', hi: 'अवरोध और संकेत' }, references: '29 CFR 1926.200–1926.203', contentReady: true },
...
export const confinedSpaceCourse: Record<CourseLanguage, CourseLesson> = {
  en: {
    slides: [
      ...
      { n: '05', title: 'Test in order—and reject an unacceptable reading', text: 'Use a calibrated direct-reading instrument before entry and as often as necessary during entry. Test oxygen first: only 19.5% through 23.5% is acceptable; below 19.5% or above 23.5% is not acceptable. Test combustible gases second: keep below 10% of the lower flammable limit (LFL); 10% or more is not an acceptable entry condition. Test toxic gases third: each reading must be below its OSHA permissible exposure limit and any stricter permit or SDS limit—there is no single ppm limit for every toxic gas. Entrants may observe testing and receive results.', ref: '29 CFR 1926.1202; 1926.1204(e)' },
    ...
    quiz: [
      ...
      { q: 'Which testing sequence and entry limits are correct?', a: ['Toxics first; any oxygen above 18%', 'Combustibles first; 10% LFL is always acceptable', 'Oxygen first (19.5%–23.5%), combustibles second (below 10% LFL), then toxics below applicable limits', 'Order and limits are optional when ventilation is running'], correct: 2 },
  ...
  ar: {
    slides: [
      ...
      { n: '05', title: 'اختبر بالترتيب وارفض أي قراءة غير مقبولة', text: 'استخدم جهاز قراءة مباشرة معايراً قبل الدخول وبالقدر اللازم أثناءه. اختبر الأكسجين أولاً: المقبول فقط من 19.5٪ إلى 23.5٪؛ ما دون 19.5٪ أو فوق 23.5٪ غير مقبول. ثانياً القابلية للاشتعال: أقل من 10٪ من الحد الأدنى للاشتعال LFL؛ 10٪ أو أكثر غير مقبول للدخول. ثالثاً الغازات السامة: يجب أن تكون كل قراءة دون حد التعرض المسموح من OSHA وأي حد أشد في التصريح أو SDS؛ لا يوجد حد ppm واحد لكل السموم.', ref: '29 CFR 1926.1202; 1926.1204(e)' },
    ...
    quiz: [
      ...
      { q: 'ما التسلسل والحدود الصحيحة للاختبار؟', a: ['السموم أولاً وأي أكسجين فوق 18٪', 'الاشتعال أولاً و10٪ LFL مقبول دائماً', 'الأكسجين أولاً 19.5–23.5٪، ثم الاشتعال أقل من 10٪ LFL، ثم السموم دون الحدود المطبقة', 'الترتيب والحدود اختيارية مع التهوية'], correct: 2 },
  ...
  ur: {
    slides: [
      ...
      { n: '05', title: 'ترتیب سے test کریں اور غلط reading رد کریں', text: 'داخلے سے پہلے اور دوران calibrated direct-reading آلہ استعمال کریں۔ پہلے oxygen: صرف 19.5% سے 23.5% قابل قبول؛ اس سے کم یا زیادہ ناقابل قبول۔ دوسرے combustible gases: 10% LFL سے کم؛ 10% یا زیادہ entry کے لیے ناقابل قبول۔ تیسرے toxic gases: ہر reading متعلقہ OSHA PEL اور permit/SDS کے زیادہ سخت limit سے کم ہو؛ ہر toxic gas کے لیے ایک universal ppm limit نہیں۔', ref: '29 CFR 1926.1202; 1926.1204(e)' },
    ...
    quiz: [
      ...
      { q: 'صحیح testing order اور limits کون سے ہیں؟', a: ['toxics پہلے؛ oxygen 18% سے اوپر', 'combustibles پہلے؛ 10% LFL ہمیشہ قبول', 'oxygen 19.5–23.5%، پھر combustibles 10% LFL سے کم، پھر toxics applicable limits سے کم', 'ventilation ہو تو order/limits اختیاری'], correct: 2 },
  ...
  hi: {
    slides: [
      ...
      { n: '05', title: 'क्रम से जाँचें और अस्वीकार्य रीडिंग रोकें', text: 'प्रवेश से पहले और दौरान आवश्यकतानुसार calibrated direct-reading यंत्र उपयोग करें। पहले oxygen: केवल 19.5% से 23.5% स्वीकार्य; इससे कम या अधिक अस्वीकार्य। दूसरे combustible gases: 10% LFL से कम; 10% या अधिक प्रवेश हेतु स्वीकार्य नहीं। तीसरे toxic gases: प्रत्येक reading लागू OSHA PEL और permit/SDS के अधिक कठोर limit से कम हो; सभी toxic gases का एक universal ppm limit नहीं है।', ref: '29 CFR 1926.1202; 1926.1204(e)' },
    ...
    quiz: [
      ...
      { q: 'सही testing क्रम और limits कौन-से हैं?', a: ['toxics पहले; oxygen 18% से ऊपर', 'combustibles पहले; 10% LFL हमेशा स्वीकार्य', 'oxygen 19.5–23.5%, फिर combustibles 10% LFL से कम, फिर toxics लागू limits से कम', 'ventilation में क्रम/limits वैकल्पिक'], correct: 2 },
